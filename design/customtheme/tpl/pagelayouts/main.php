...
<script type="text/javascript">
    $(function () {
        $(window).click(function() {
            if($('.sidebar-floater#chat').is(':visible')) {
                $('.sidebar-floater#chat').css('display', 'none');
            }
            if($('.sidebar-floater#modules').is(':visible')) {
                $('.sidebar-floater#modules').css('display', 'none');
            }
        });

        $('#module-li').click(function (event) {
            event.stopPropagation();
            if($('#wrapper').hasClass('toggled')){
                $('.sidebar-floater#modules').css('display', 'block');
            }
        });

        $('#chat-li').click(function (event) {
            event.stopPropagation();
            if($('#wrapper').hasClass('toggled')){
                $('.sidebar-floater#chat').css('display', 'block');
            }
        });
