			...
			<div class="row">
				<div class="col-md-6">
					...
					<ul>
                        ...
                        <?php if ($currentUser->hasAccessTo('lhsystem','timezone')) : ?>
                        <li><a href="<?php echo erLhcoreClassDesign::baseurl('system/facebook')?>">
                            <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','Facebook settings');?>
                        </a></li>
                        <?php endif; ?>
        			</ul>
				</div>
